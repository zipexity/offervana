...
class BuildComparables extends React.Component {
  state = {
    homeComparables: "",
    UserId: ""
  };
  ...
  handleFormSubmit = event => {
    ...
    APIserver.updateUser({
      ...
      comparables: this.state.homeComparables
  ...
  componentDidMount = () => {
    ...
    APIserver.multiofferUserReturn(user[1]).then(res => {
      console.log(res.data.comparables);
      if (res.data.comparables === null) {
      } else {
        console.log(res.data);
        this.setState({
          homeComparables: res.data.comparables,
...
BuildComparables.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(BuildComparables);
