...
class BathRemod extends React.Component {
  state = {
    q24bathremod: localStorage.getItem("q24bathremod"),
    buttonStatus: true
  };
  ...
  componentDidMount = () => {
    let val = localStorage.getItem("q24bathremod");
    this.check("name", val);
  };

  submitAnswers = () => {
    localStorage.setItem("q24bathremod", this.state.q24bathremod);
  ...
  render() {
    ...
    const submitButton = props => <Link to="/homesurvey/q13" {...props} />;
    const backButton = props => <Link to="/homesurvey/q11" {...props} />;
                      ...
                      <Grid direction="column" container spacing={8}>
                        ...
                        <Grid item md={12} align="center">
                          <FormControl component="fieldset">
                            <RadioGroup
                              aria-label="q24bathremod"
                              name="q24bathremod"
                              value={this.state.q24bathremod}
...
export default withStyles(styles)(BathRemod);
