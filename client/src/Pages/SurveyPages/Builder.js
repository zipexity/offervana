...
class Builder extends React.Component {
  state = {
    q39builder: localStorage.getItem("q39builder"),
    buttonStatus: true
  };
  ...
  componentDidMount = () => {
    let val = localStorage.getItem("q39builder");
    this.check("name", val);
  };

  submitAnswers = () => {
    localStorage.setItem("q39builder", this.state.q39builder);
  ...
  render() {
    ...
    const submitButton = props => <Link to="/homesurvey/q36" {...props} />;
    const backButton = props => <Link to="/homesurvey/q34" {...props} />;
                      ...
                      <Grid direction="column" container spacing={8}>
                        ...
                        <Grid item md={12}>
                          <Grid direction="row" container>
                            ...
                            <Grid item md={12} sm={12} xs={12} align="center">
                              ...
                              >
                                Are You Currently Working With a Home Builder?
                                <hr />
                              </Typography>
                            </Grid>
                          </Grid>
                        ...
                        <Grid item md={12} align="center">
                          <FormControl component="fieldset">
                            <RadioGroup
                              aria-label="q39builder"
                              name="q39builder"
                              value={this.state.q39builder}
