...
const styles = theme => ({
  ...
  bad: { marginRight: "0em", width: "200px" },
  avg: { marginRight: "0em", width: "200px" },
  new: { marginRight: "0em", width: "200px" }
});

class Facade extends React.Component {
  state = {
    q35facade: localStorage.getItem("q35facade"),
    buttonStatus: true
  };
  ...
  componentDidMount = () => {
    let val = localStorage.getItem("q35facade");
    this.check("name", val);
  };

  submitAnswers = () => {
    localStorage.setItem("q35facade", this.state.q35facade);
                      ...
                      <Grid direction="column" container spacing={8}>
                        ...
                        <Grid item md={12} align="center">
                          <FormControl component="fieldset">
                            <RadioGroup
                              aria-label="q35facade"
                              name="q35facade"
                              value={this.state.q35facade}
...
export default withStyles(styles)(Facade);
