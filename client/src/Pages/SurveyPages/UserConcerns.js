...
class UserConcerns extends React.Component {
  state = {
    userConcerns: localStorage.getItem("userConcerns"),
    buttonStatus: false
  };
  ...
  componentDidMount = () => {
    let val = localStorage.getItem("userConcerns");
  };

  submitAnswers = () => {
    localStorage.setItem("comingFrom", "left");
    localStorage.setItem("userConcerns", this.state.userConcerns);
  };
  ...
  render() {
    ...
    const submitButton = props => <Link to="/homesurvey/q38" {...props} />;
    const backButton = props => <Link to="/homesurvey/q36" {...props} />;
                    ...
                    <Grid item md={12} xs={12}>
                      <Grid direction="column" container spacing={8}>
                        ...
                        <Grid item md={12} align="center">
                          <TextField
                            id="userConcerns"
                            label="Add any extra info here"
                            multiline
                            rowsMax="10"
                            value={this.state.userConcerns}
                            onChange={this.handleChange("userConcerns")}
                            className={classes.userConcerns}
                            margin="normal"
                            variant="outlined"
                            color="primary"
                          />
...
UserConcerns.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(UserConcerns);
